...
- A fresh live service-worker context registered `sw.js?build=0.1.8-166e4d6b6690`; after its first normal reload, `/demo` reloaded offline with the sample roster and Ava Shah visible.
