...
export function mountPresenceApp(root: HTMLElement, options: MountOptions = {}): () => void {
  ...
  const render = () => {
    ...
    root.innerHTML = `<div class="presence-app ${options.embedded ? "embedded" : ""}">
      ...
      ${options.embedded ? "" : `<footer class="app-footer"><p>See who is free, then open a contact tool.</p><nav aria-label="App footer navigation"><a href="/privacy">Privacy</a><a href="/terms">Terms</a><a href="https://sociobot.in" rel="external">Built by Param Factory</a></nav><p>v0.1.12</p></footer>`}
    </div>`;
    bind();
