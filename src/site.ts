...
const footer = `<footer class="site-footer"><p><strong>Presence Bridge</strong><br><span>See who is free, then open your existing tool.</span></p><nav aria-label="Footer navigation"><a href="/privacy" data-route>Privacy</a><a href="/terms" data-route>Terms</a><a href="https://sociobot.in" rel="external">Built by Param Factory</a></nav><p>v0.1.3 · Original generated artwork</p></footer>`;
...
const home = (): string => `<div class="site-page home-page">${header}<main id="main">
  ...
  <section class="boundary" aria-labelledby="boundary-title"><div class="boundary-art" aria-hidden="true"><span></span><span></span><span></span></div><div><p class="eyebrow">A quiet boundary</p><h2 id="boundary-title">This is not another inbox</h2><p>Presence Bridge does not carry messages or infer activity. You choose every status. Calendar import reads a local .ics file only when you select it.</p></div></section>
