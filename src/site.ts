...
const footer = `<footer class="site-footer"><p><strong>Presence Bridge</strong><br><span>See who is free, then open your existing tool.</span></p><nav aria-label="Footer navigation"><a href="/privacy" data-route>Privacy</a><a href="/terms" data-route>Terms</a><a href="https://sociobot.in" rel="external">Built by Param Factory</a></nav><p>v0.1.2 · Original generated artwork</p></footer>`;
