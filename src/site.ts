...
const footer = `<footer class="site-footer"><p><strong>Presence Bridge</strong><br><span>See who is free, then open your existing tool.</span></p><nav aria-label="Footer navigation"><a href="/privacy" data-route>Privacy</a><a href="/terms" data-route>Terms</a><a href="https://sociobot.in" rel="external">Built by Param Factory</a></nav><p>v0.1.8 · Original generated artwork</p></footer>`;
...
const home = (): string => `<div class="site-page home-page">${header}<main id="main">
  ...
  <section class="price-strip" aria-labelledby="price-title"><div><p class="eyebrow">Bridge Plus · $24 once when available</p><h2 id="price-title">More room, same quiet roster</h2><p>Add up to ten people and more contact routes. The free local roster holds five.</p></div><div class="checkout-actions"><p>Bridge Plus purchases are not available right now. The free five-person roster is ready now.</p><p>Already have a license? Restore it in the desktop app Settings.</p></div></section>
</main>${footer}</div>`;
