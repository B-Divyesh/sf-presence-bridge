...
test("390px routes, dynamic release links, dialogs, and app footer keep 44px targets", async ({ page }, testInfo) => {
  ...
  await page.route("https://api.github.com/repos/B-Divyesh/sf-presence-bridge/releases?per_page=1", route => route.fulfill({
    ...
    body: JSON.stringify([{ tag_name: "v0.1.17", assets: [
      { name: "Presence.Bridge_0.1.17_amd64.AppImage", size: 1_200, browser_download_url: "https://github.com/B-Divyesh/sf-presence-bridge/releases/download/v0.1.17/Presence.Bridge_0.1.17_amd64.AppImage" },
      { name: "Presence.Bridge_0.1.17_x64-setup.exe", size: 1_200, browser_download_url: "https://github.com/B-Divyesh/sf-presence-bridge/releases/download/v0.1.17/Presence.Bridge_0.1.17_x64-setup.exe" },
      { name: "SHA256SUMS", size: 900, browser_download_url: "https://github.com/B-Divyesh/sf-presence-bridge/releases/download/v0.1.17/SHA256SUMS" },
      { name: "latest.json", size: 800, browser_download_url: "https://github.com/B-Divyesh/sf-presence-bridge/releases/download/v0.1.17/latest.json" }
    ] }])
  }));
